...
function embedbuilder(client, deletetime, message, color, title, description, thumbnail) {
    ...
    try {
        let embed = new Discord.MessageEmbed()
            ...
            .setFooter(client.user.username + " | by: Discord Portal", client.user.displayAvatarURL());
...
async function playsongyes(client, message, queue, song) {
    try {
        ...
        let embed1 = new Discord.MessageEmbed()
            ...
            .setColor(config.colors.yes)
            .setDescription(`<:youtube:870897495729897482> Song: [\`${song.name}\`](${song.url})`)
            .addField("<:dot:870884326919766066>  Requested by:", `>>> ${song.user}`, true)
            .addField("<:68747470733a2f2f63646e2e64697363:870884326877823026>  Loop:", `>>> ${queue.repeatMode ? queue.repeatMode === 2 ? "<:yes:870876799138152448>  Queue" : "<:yes:870876799138152448>  Song" : "<:no:870876822030671872> "}`, true)
            .addField("<:seek:870884327054008361>  Autoplay:", `>>> ${queue.autoplay ? "<:yes:870876799138152448> " : "<:no:870876822030671872> "}`, true)
            .addField("<:question:870884326953341018> Download Song:", `>>> [\`Click here\`](${song.streamURL})`, true)
            .addField("<:question:870884326953341018> Filter:", `>>> \`${queue.filter || "<:no:870876822030671872> "}\``, true)
            .addField("<:radio:870884571510624277>  DJ-Role:", `>>> ${djs}`, true)
